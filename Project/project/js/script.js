...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // ** функционал, что после заполнения формы и нажатия кнопки "Подтвердить" - новый фильм добавляется в список
    ...
    addForm.addEventListener('submit', (e) => {
        ...
        // * условие если символов больше 21, то дальше добавляются ...
        if (newFilm) {
